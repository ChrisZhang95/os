...
struct lock {
	char *name;
	volatile int held; //to check is the lock is being used, 1 means being used and 0 means not being used
	volatile struct thread *holder; //the thread that is currently holding the lock
